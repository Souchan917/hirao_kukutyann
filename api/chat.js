...
// 共通のGPT応答取得関数
async function getGPTResponse(prompt, apiKey, stage) {
    try {
        console.group(`------- ${stage} -------`);
        console.log('送信プロンプト:');
        console.log(prompt);
        ...
        console.error(`${stage}でエラー発生:`, error);
        console.groupEnd();
        throw error;
    }
}
...
export default async function handler(req, res) {
    ...
    try {
        ...
        const messageType = await getGPTResponse(classificationPrompt, apiKey, '分類');
